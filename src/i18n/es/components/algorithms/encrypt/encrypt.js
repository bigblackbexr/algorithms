...
const p2 = {
  a:
    `<p class="${classes.cP2}">Cifrado Simétrico</p>`,
  b:
    `<p class="${classes.rellenoP2}"> También conocido como criptografía de clave secreta, utiliza la misma clave para cifrar y descifrar información.
  ...
  c:
    `<p class="${classes.cP2}">Cifrado Asimétrico</p>`,
  d:
    `<p class="${classes.rellenoP2}"> También conocido como criptografía de clave pública, utiliza una clave pública y una clave privada para cifrar y descifrar información.
...
const p3 = {
  ...
  b:
    `<p class="${classes.cp3}">1. Protección de Datos de Usuario</p>`,
  c:
    `<p class="${classes.cp3}">2. Comunicaciones Seguras</p>`,
  d:
    `<p class="${classes.cp3}">3. Sistemas de Pago en Línea</p>`,
  e:
    `<p class="${classes.cp3}">4. Protección de Archivos y Discos</p> <br>`
};
